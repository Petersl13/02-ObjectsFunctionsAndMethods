...
def main():
    ...
    #better_draw_circles(rg.Point(100,30),3)
    #better_draw_circles(rg.Point(-100,70),25)
    #even_better_draw_circles(rg.Point(200,30),4,15,'blue',1)
    #even_better_draw_circles(rg.Point(-200,40),13,20,'magenta',4)
    better_draw_circles(rg.Point(-200,3),3)
    better_draw_circles(rg.Point(200,3),3)
    even_better_draw_circles(rg.Point(250,30),7,20,'green',3)
    even_better_draw_circles(rg.Point(-100,45),9,37,'magenta',1)
    even_better_draw_circles(rg.Point(-300,-40),10,29,'blue',3)
    even_better_draw_circles(rg.Point(300,-150),9,15,'red',7)
    window.update()
...
def even_better_draw_circles(point,radius,n,color,thickness):
