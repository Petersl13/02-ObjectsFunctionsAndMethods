...
def try_methods():
    ...
    ###########################################################################
    gabby = rg.SimpleTurtle('turtle')
    gabby.pen = rg.Pen('brown',5)
    gabby.speed = 4
    gabby.forward(150)
    gabby.left(90)
    gabby.forward(50)
...
def try_methods_and_functions():
    ...
    hugo.pen = rg.Pen('blue',5)
    hugo.speed = 5
    hugo.backward(150)
    hugo.speed = 1
    draw_many_squares(hugo,2,100,30)
    hugo.speed = 5
    hugo.pen = rg.Pen('red',5)
    draw_many_squares(hugo,10,50,15)
    hugo.speed = 100
    hugo.pen = rg.Pen('red',35)
    draw_many_squares(hugo,8,300,60)
    hugo.pen = rg.Pen('black',3)
    hugo.backward(200)
    hugo.draw_circle(30)
    hugo.draw_square(50)
